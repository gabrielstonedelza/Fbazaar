...
class AssignDriverToOrderSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id','order','user_with_order','driver','date_created','get_item_code','get_ordered_username','get_item_details','get_order_drop_off_lat','get_order_drop_off_lng','get_user_phone_number']
        read_only_fields = ['order']
