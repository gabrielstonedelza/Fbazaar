...
urlpatterns =[
    ...
    path("increase_item_quantity/<int:id>/<int:item_id>/",views.increase_item_quantity),
    path("decrease_item_quantity/<int:id>/<int:item_id>/",views.decrease_item_quantity),
